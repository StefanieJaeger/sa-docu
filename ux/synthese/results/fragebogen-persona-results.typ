...
- Das Tool ist einfach in der Handhabung, insbesondere das Verschieben von Modulen und die intuitive Darstellung durch Kacheln (zwei Nennungen).
...
Die Fachkraft in der Studienberatung führt mehrfach Gespräche zur Modulplanung, wobei solche Anfragen verstärkt nach Prüfungen und während der Anmeldephase auftreten (ca. 10 pro Semester).
Obwohl die Fachkraft den Semesterplaner kennt, wird dieser nicht genutzt, da die Verantwortung für die Planung bei den Studierenden liegt.
Stattdessen kommen offizielle Dokumente, Prüfungsreglemente, Informationen der Studienleitung sowie Tools wie Mail, Kalender und Teams zum Einsatz.
Der Semesterplaner wird als hilfreiches Tool angesehen, dessen Integration in bestehende Plattformen empfohlen wird, um die Modulplanung zu erleichtern und zu standardisieren.
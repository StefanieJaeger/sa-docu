...
#figure(image("DigiCamp.png", width:60%), caption: [Externe Leistung]) <digicamp>
...
- Hast du sonst noch Feedback?
Falls nicht erwähnt in den Antworten, eventuell Fragen stellen zur Bedienung und den visuellen Änderungen.
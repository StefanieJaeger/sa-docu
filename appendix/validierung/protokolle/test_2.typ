= Protokoll Usability Test 2 <ut_2>
...
Die Testperson hat den Link gesehen und geöffnet.

- Ist der Zusammenhang des Studiumsstarts und der Verlinkung selbsterklärend?
Die Testperson versucht zuerst über die Studienordnung selbst zur älteren zu kommen.
Dann versucht sie über die Musterpläne zur älteren Studienordnung zu kommen.
Sie versucht zum Schluss noch das Startsemester 2 Jahre zurück zu stellen und findet so die ältere Studienordnung.
...
Der Testperson war klar, dass sie über eine Vertiefung ein Modul hinzufügen kann.
...
Die Testperson sucht nach dem Namen einer Kategorie, anstatt zu scrollen oder die anderen Kategorien zuzuklappen.
So kommt sie zufälligerweise über den Suchbegriff "Gesel" zum Modul "Alternde Gesellschaft".

- Ist die direkte Suche nach einem Modul in der Suche verständlich?
Die Testperson kann über Name und Kürzel ein Modul finden.

- Ist eine Nicht-Auswählbarkeit in der Suche und deren Grund klar?
Die Testperson sieht bei der Suche im FS25, dass das Modul dort nicht planbar ist.
...
Ihr war dadurch nicht klar, dass dies normale Module sind.
...
Die Testperson verstand die Validierung.

- Ist der Fehler bei doppelten Modulen (Plan und Übertritt) verständlich?
Ihr war der Fehler klar und sie entfernte das duplizierte Modul über den Button in der Fehlermeldung.
Sie war ein wenig verunsichert, da die globale Fehlermeldung die Fehler bei den Übertrittsmodulen nicht erwähnte.
Sie löscht die duplizierten Übertrittsmodule von Hand und kontrolliert anschliessend die Kategorien.

- Ist der Fehler bei einem Modul im falschen, offenen Semester verständlich?
Ihr war der Fehler klar und sie verschob das Modul über den Button in der Fehlermeldung.

- Ist der Fehler bei einem inaktiven Modul in einem offenen Semester verständlich?
Ihr war der Fehler klar und sie ersetzt ein Modul durch dessen Nachfolger und entfernte das andere, beides über die Buttons in der Fehlermeldung.
...
Sie ging nicht auf diesen Hinweis ein.
Im Nachgespräch erwähnte sie ihn jedoch, er fiel ihr also auf.
